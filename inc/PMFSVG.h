...
int U_PMR_STROKEFILLPATH_print(const char *contents, FILE *out);      /* not documented */
int U_PMR_MULTIFORMATSTART_print(const char *contents, FILE *out);    /* last of reserved but not used */
int U_PMR_MULTIFORMATSECTION_print(const char *contents, FILE *out);  /* last of reserved but not used */
int U_PMR_MULTIFORMATEND_print(const char *contents, FILE *out);      /* last of reserved but not used */
