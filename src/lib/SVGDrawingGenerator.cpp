...
{
	SVGDrawingGeneratorPrivate(librevenge::RVNGStringVector &vec, const librevenge::RVNGString &nmSpace);
...
SVGDrawingGeneratorPrivate::SVGDrawingGeneratorPrivate(librevenge::RVNGStringVector &vec, const librevenge::RVNGString &nmSpace) :
	m_idSpanMap(),
	m_gradient(),
	m_style(),
	m_gradientIndex(1),
...
void SVGDrawingGeneratorPrivate::drawPolySomething(const librevenge::RVNGPropertyListVector &vertices, bool isClosed)
{
	if (vertices.count() < 2)
		return;
...
void SVGDrawingGeneratorPrivate::setStyle(const librevenge::RVNGPropertyList &propList)
{
	m_style.clear();
	m_style = propList;
...
SVGDrawingGenerator::SVGDrawingGenerator(librevenge::RVNGStringVector &vec, const librevenge::RVNGString &nmSpace) :
...
void SVGDrawingGenerator::startDocument(const librevenge::RVNGPropertyList & /*propList*/) {}
void SVGDrawingGenerator::endDocument() {}
void SVGDrawingGenerator::setDocumentMetaData(const librevenge::RVNGPropertyList & /*propList*/) {}
void SVGDrawingGenerator::defineEmbeddedFont(const librevenge::RVNGPropertyList & /*propList*/) {}
...
void SVGDrawingGenerator::startMasterPage(const librevenge::RVNGPropertyList &)
{
}
...
void SVGDrawingGenerator::startLayer(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::setStyle(const librevenge::RVNGPropertyList &propList)
{
	m_pImpl->setStyle(propList);
}

void SVGDrawingGenerator::drawRectangle(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::drawEllipse(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::drawPolyline(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::drawPolygon(const librevenge::RVNGPropertyList &propList)
{
	const librevenge::RVNGPropertyListVector *vertices = propList.child("svg:points");
	if (vertices && vertices->count())
...
void SVGDrawingGenerator::drawPath(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::drawGraphicObject(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::startTextObject(const librevenge::RVNGPropertyList &propList)
{
	double x = 0.0;
	double y = 0.0;
	double height = 0.0;
...
void SVGDrawingGenerator::defineCharacterStyle(const librevenge::RVNGPropertyList &propList)
{
	...
	{
		//librevenge::RVNG_DEBUG_MSG(("SVGDrawingGenerator::defineCharacterStyle: can not find the span-id\n"));
		return;
	}
	m_pImpl->m_idSpanMap[propList["librevenge:span-id"]->getInt()]=propList;
}

void SVGDrawingGenerator::openSpan(const librevenge::RVNGPropertyList &propList)
{
...
void SVGDrawingGenerator::openLink(const librevenge::RVNGPropertyList & /*propList*/) {}
