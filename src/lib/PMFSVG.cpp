...
*/
int U_PMR_NODATAREC_print(const char *contents, char *out){
...
*/
void U_PMF_VARPOINTS_print(const char **contents, int Flags, uint32_t Elements, char * out){
   unsigned int i;
   U_FLOAT Xpos, Ypos;
...
/* 
 this function is not visible in the API.  Common routine used by many functions that draw points.
*/
void U_PMF_VARPOINTF_S_print(U_PMF_POINTF *Points, uint32_t Elements, char * out){
   unsigned int i;
   printf("   +  Points:");
...
*/
int U_PMF_VARRECTF_S_print(U_PMF_RECTF *Rects, uint32_t Elements, char *out){
...
*/
int U_PMF_VARBRUSHID_print(int btype, uint32_t BrushID, char *out){
   if(btype){
      printf(" Color:");
...
*/
int U_pmf_onerec_print(const char *contents, const char *blimit, int recnum, int off, char *out){
   int status;
   ...
   status = U_PMF_CMN_HDR_print(Header, recnum, off, out);  /* EMF+ part */
   ...
   switch(type){  
      case (U_PMR_HEADER):                   U_PMR_HEADER_print(contents, out);                       break;                     
      case (U_PMR_ENDOFFILE):                U_PMR_ENDOFFILE_print(contents, out);
                                             U_OA_release(&ObjCont);                             break;
      case (U_PMR_COMMENT):                  U_PMR_COMMENT_print(contents, out);                      break;
      case (U_PMR_GETDC):                    U_PMR_GETDC_print(contents, out);                        break;
      case (U_PMR_MULTIFORMATSTART):         U_PMR_MULTIFORMATSTART_print(contents, out);             break;
      case (U_PMR_MULTIFORMATSECTION):       U_PMR_MULTIFORMATSECTION_print(contents, out);           break;
      case (U_PMR_MULTIFORMATEND):           U_PMR_MULTIFORMATEND_print(contents, out);               break;
      case (U_PMR_OBJECT):                   U_PMR_OBJECT_print(contents,blimit,&ObjCont,0, out);     break;
      case (U_PMR_CLEAR):                    U_PMR_CLEAR_print(contents, out);                        break;
      case (U_PMR_FILLRECTS):                U_PMR_FILLRECTS_print(contents, blimit, out);            break;
      case (U_PMR_DRAWRECTS):                U_PMR_DRAWRECTS_print(contents, blimit, out);            break;
      case (U_PMR_FILLPOLYGON):              U_PMR_FILLPOLYGON_print(contents, out);                  break;
      case (U_PMR_DRAWLINES):                U_PMR_DRAWLINES_print(contents, out);                    break;
      case (U_PMR_FILLELLIPSE):              U_PMR_FILLELLIPSE_print(contents, out);                  break;
      case (U_PMR_DRAWELLIPSE):              U_PMR_DRAWELLIPSE_print(contents, out);                  break;
      case (U_PMR_FILLPIE):                  U_PMR_FILLPIE_print(contents, out);                      break;
      case (U_PMR_DRAWPIE):                  U_PMR_DRAWPIE_print(contents, out);                      break;
      case (U_PMR_DRAWARC):                  U_PMR_DRAWARC_print(contents, out);                      break;
      case (U_PMR_FILLREGION):               U_PMR_FILLREGION_print(contents, out);                   break;
      case (U_PMR_FILLPATH):                 U_PMR_FILLPATH_print(contents, out);                     break;
      case (U_PMR_DRAWPATH):                 U_PMR_DRAWPATH_print(contents, out);                     break;
      case (U_PMR_FILLCLOSEDCURVE):          U_PMR_FILLCLOSEDCURVE_print(contents, out);              break;
      case (U_PMR_DRAWCLOSEDCURVE):          U_PMR_DRAWCLOSEDCURVE_print(contents, out);              break;
      case (U_PMR_DRAWCURVE):                U_PMR_DRAWCURVE_print(contents, out);                    break;
      case (U_PMR_DRAWBEZIERS):              U_PMR_DRAWBEZIERS_print(contents, out);                  break;
      case (U_PMR_DRAWIMAGE):                U_PMR_DRAWIMAGE_print(contents, out);                    break;
      case (U_PMR_DRAWIMAGEPOINTS):          U_PMR_DRAWIMAGEPOINTS_print(contents, out);              break;
      case (U_PMR_DRAWSTRING):               U_PMR_DRAWSTRING_print(contents, out);                   break;
      case (U_PMR_SETRENDERINGORIGIN):       U_PMR_SETRENDERINGORIGIN_print(contents, out);           break;
      case (U_PMR_SETANTIALIASMODE):         U_PMR_SETANTIALIASMODE_print(contents, out);             break;
      case (U_PMR_SETTEXTRENDERINGHINT):     U_PMR_SETTEXTRENDERINGHINT_print(contents, out);         break;
      case (U_PMR_SETTEXTCONTRAST):          U_PMR_SETTEXTCONTRAST_print(contents, out);              break;
      case (U_PMR_SETINTERPOLATIONMODE):     U_PMR_SETINTERPOLATIONMODE_print(contents, out);         break;
      case (U_PMR_SETPIXELOFFSETMODE):       U_PMR_SETPIXELOFFSETMODE_print(contents, out);           break;
      case (U_PMR_SETCOMPOSITINGMODE):       U_PMR_SETCOMPOSITINGMODE_print(contents, out);           break;
      case (U_PMR_SETCOMPOSITINGQUALITY):    U_PMR_SETCOMPOSITINGQUALITY_print(contents, out);        break;
      case (U_PMR_SAVE):                     U_PMR_SAVE_print(contents, out);                         break;
      case (U_PMR_RESTORE):                  U_PMR_RESTORE_print(contents, out);                      break;
      case (U_PMR_BEGINCONTAINER):           U_PMR_BEGINCONTAINER_print(contents, out);               break;
      case (U_PMR_BEGINCONTAINERNOPARAMS):   U_PMR_BEGINCONTAINERNOPARAMS_print(contents, out);       break;
      case (U_PMR_ENDCONTAINER):             U_PMR_ENDCONTAINER_print(contents, out);                 break;
      case (U_PMR_SETWORLDTRANSFORM):        U_PMR_SETWORLDTRANSFORM_print(contents, out);            break;
      case (U_PMR_RESETWORLDTRANSFORM):      U_PMR_RESETWORLDTRANSFORM_print(contents, out);          break;
      case (U_PMR_MULTIPLYWORLDTRANSFORM):   U_PMR_MULTIPLYWORLDTRANSFORM_print(contents, out);       break;
      case (U_PMR_TRANSLATEWORLDTRANSFORM):  U_PMR_TRANSLATEWORLDTRANSFORM_print(contents, out);      break;
      case (U_PMR_SCALEWORLDTRANSFORM):      U_PMR_SCALEWORLDTRANSFORM_print(contents, out);          break;
      case (U_PMR_ROTATEWORLDTRANSFORM):     U_PMR_ROTATEWORLDTRANSFORM_print(contents, out);         break;
      case (U_PMR_SETPAGETRANSFORM):         U_PMR_SETPAGETRANSFORM_print(contents, out);             break;
      case (U_PMR_RESETCLIP):                U_PMR_RESETCLIP_print(contents, out);                    break;
      case (U_PMR_SETCLIPRECT):              U_PMR_SETCLIPRECT_print(contents, out);                  break;
      case (U_PMR_SETCLIPPATH):              U_PMR_SETCLIPPATH_print(contents, out);                  break;
      case (U_PMR_SETCLIPREGION):            U_PMR_SETCLIPREGION_print(contents, out);                break;
      case (U_PMR_OFFSETCLIP):               U_PMR_OFFSETCLIP_print(contents, out);                   break;
      case (U_PMR_DRAWDRIVERSTRING):         U_PMR_DRAWDRIVERSTRING_print(contents, out);             break;
      case (U_PMR_STROKEFILLPATH):           U_PMR_STROKEFILLPATH_print(contents, out);               break;
      case (U_PMR_SERIALIZABLEOBJECT):       U_PMR_SERIALIZABLEOBJECT_print(contents, out);           break;
      case (U_PMR_SETTSGRAPHICS):            U_PMR_SETTSGRAPHICS_print(contents, out);                break;
      case (U_PMR_SETTSCLIP):                U_PMR_SETTSCLIP_print(contents, out);                    break;
   }
   return(status);
}
...
*/
int U_PMF_CMN_HDR_print(U_PMF_CMN_HDR Header, int precnum, int off, char *out){
...
*/
int U_PMF_UINT8_ARRAY_print(const char *Start, const uint8_t *Array, int Elements, char *End, char *out){
...
*/
int U_PMF_BRUSHTYPEENUMERATION_print(int otype, char *out){
   int status=1;
   switch(otype){
...
*/
int U_PMF_COMBINEMODEENUMERATION_print(int otype, char *out){
   int status=1;
   switch(otype){
...
*/
int U_PMF_HATCHSTYLEENUMERATION_print(int hstype, char *out){
   int status=1;
   switch(hstype){
...
*/
int U_PMF_OBJECTTYPEENUMERATION_print(int otype, char *out){
   int status=1;
   switch(otype){
...
*/
int U_PMF_PATHPOINTTYPE_ENUM_print(int Type, char *out){
...
*/
int U_PMF_PX_FMT_ENUM_print(int pfe, char *out){
   uint8_t idx;
   printf("   +  PxFmtEnum: ");
...
*/
int U_PMF_NODETYPE_print(int Type, char *out){
...
*/
int U_PMF_BRUSH_print(const char *contents, char *out){
...
*/
int U_PMF_CUSTOMLINECAP_print(const char *contents, const char *Which, char *out){
   uint32_t Version, Type;
   const char *Data;
   ...
   if(status){      
      ...
      switch(Type){
         ...
         case U_CLCDT_AdjustableArrow:
            status = U_PMF_CUSTOMLINECAPARROWDATA_print(Data, out);
            break;
         default:
            status = 0;
      }
...
*/
int U_PMF_FONT_print(const char *contents, char *out){
...
*/
int U_PMF_IMAGE_print(const char *contents, char *out){
   uint32_t Version, Type;
   const char *Data;
      ...
      switch(Type){
        case U_IDT_Unknown:
         ...
         case U_IDT_Bitmap:
            ...
            break;
         case U_IDT_Metafile:
            status = U_PMF_METAFILE_print(Data, out);
            break;
         default:
            status = 0;
      }
...
*/
int U_PMF_IMAGEATTRIBUTES_print(const char *contents, char *out){
...
*/
int U_PMF_PATH_print(const char *contents, char *out){
   unsigned int i, pos;
...
*/
int U_PMF_PEN_print(const char *contents, char *out){
   uint32_t     Version, Type;
   const char  *PenData;
   const char  *Brush;
...
*/
int U_PMF_REGION_print(const char *contents, char *out){
   uint32_t      Version, Count;
   const char   *Nodes;
...
*/
int U_PMF_STRINGFORMAT_print(const char *contents, char *out){
...
*/
int U_PMF_ARGB_print(const char *contents, char *out){
...
*/
int U_PMF_BITMAP_print(const char *contents, char *out){
   U_PMF_BITMAP  Bs;
   const char *Data;
...
*/
int U_PMF_BITMAPDATA_print(const char *contents, char *out){
   unsigned int  i;
   U_PMF_PALETTE Ps;
   const char   *Colors;
   const char   *Data;
...
*/
int U_PMF_BLENDCOLORS_print(const char *contents, char *out){
   unsigned int i;
   uint32_t     Elements;
   U_FLOAT     *Positions;
   const char  *Colors;
...
*/
int U_PMF_BLENDFACTORS_print(const char *contents, const char *type, char *out){
   unsigned int i;
   uint32_t     Elements;
   U_FLOAT     *Positions;
   U_FLOAT     *Factors;
...
*/
int U_PMF_BOUNDARYPATHDATA_print(const char *contents, char *out){
   int32_t       Size;
   const char *Data;
...
*/
int U_PMF_BOUNDARYPOINTDATA_print(const char *contents, char *out){
   int32_t       Elements;
   U_PMF_POINTF *Points;
...
*/
int U_PMF_CHARACTERRANGE_print(const char *contents, char *out){
...
*/
int U_PMF_COMPOUNDLINEDATA_print(const char *contents, char *out){
   int32_t       Elements;
   U_FLOAT      *Widths;
   U_FLOAT      *hold;
...
*/
int U_PMF_COMPRESSEDIMAGE_print(const char *contents, char *out){
   const char *Data;
...
*/
int U_PMF_CUSTOMENDCAPDATA_print(const char *contents, char *out){
   int32_t       Size;
   const char *Data;
...
*/
int U_PMF_CUSTOMLINECAPARROWDATA_print(const char *contents, char *out){
...
*/
int U_PMF_CUSTOMLINECAPDATA_print(const char *contents, char *out){
...
*/
int U_PMF_CUSTOMLINECAPOPTIONALDATA_print(const char *contents, uint32_t Flags, char *out){
   const char *FillData;
   const char *LineData;
...
*/
int U_PMF_CUSTOMSTARTCAPDATA_print(const char *contents, char *out){
   int32_t  Size;
   const char *Data;
...
*/
int U_PMF_DASHEDLINEDATA_print(const char *contents, char *out){
   int32_t  Elements;
   U_FLOAT *Lengths;
   U_FLOAT *hold;
...
*/
int U_PMF_FILLPATHOBJ_print(const char *contents, char *out){
   int32_t  Size;
   const char *Data;
...
*/
int U_PMF_FOCUSSCALEDATA_print(const char *contents, char *out){
   uint32_t Count;
...
*/
int U_PMF_GRAPHICSVERSION_print(const char *contents, char *out){
...
*/
int U_PMF_HATCHBRUSHDATA_print(const char *contents, char *out){
   uint32_t Style;
...
*/
int U_PMF_LANGUAGEIDENTIFIER_print(U_PMF_LANGUAGEIDENTIFIER LId, char *out){
   int SubLId, PriLId;
...
*/
int U_PMF_LINEARGRADIENTBRUSHDATA_print(const char *contents, char *out){
...
*/
int U_PMF_LINEARGRADIENTBRUSHOPTIONALDATA_print(const char *contents, int BDFlag, char *out){
   ...
   if(status){
      if(BDFlag & U_BD_Transform){
         U_PMF_TRANSFORMMATRIX2_print(&Tm, out); 
         None=0;
      }
      if(Bc){
         printf("\n");
...
*/
int U_PMF_LINEPATH_print(const char *contents, char *out){
   int32_t  Size;
   const char *Data;
...
*/
int U_PMF_METAFILE_print(const char *contents, char *out){
   uint32_t Type;
   uint32_t Size;
   const char *Data;
...
*/
int U_PMF_PALETTE_print(const char *contents, char *out){
   unsigned int i;
   uint32_t     Flags;
   uint32_t     Elements;
   const char  *Data;
...
*/
int U_PMF_PATHGRADIENTBRUSHDATA_print(const char *contents, char *out){
   ...
   if(status){
      ...
      if(Pgbd.Flags & U_BD_Path){
         ...
         (void) U_PMF_BOUNDARYPOINTDATA_print(Boundary, out);
      }
...
*/
int U_PMF_PATHGRADIENTBRUSHOPTIONALDATA_print(const char *contents, int BDFlag, char *out){
   ...
   if(BDFlag & U_BD_PresetColors){ /* If this is present, BlendFactorsH will not be */
      contents += U_PMF_BLENDCOLORS_print(contents, out);
   }
   if(BDFlag & U_BD_BlendFactorsH){/* If this is present, U_BD_PresetColors will not be */
     contents += U_PMF_BLENDFACTORS_print(contents,"", out);
   }
   if(BDFlag & U_BD_FocusScales){
     contents += U_PMF_BLENDFACTORS_print(contents,"", out);
     U_PMF_FOCUSSCALEDATA_print(contents, out);
   }
   return(1);
}
...
*/
int U_PMF_PATHPOINTTYPE_print(const char *contents, char *out){
   int Flags, Type;
...
*/
int U_PMF_PATHPOINTTYPERLE_print(const char *contents, char *out){
...
*/
int U_PMF_PENDATA_print(const char *contents, char *out){
   uint32_t  Flags, Unit;
   U_FLOAT   Width;
   const char *Data;
...
*/
int U_PMF_PENOPTIONALDATA_print(const char *contents, int Flags, char *out){
...
*/
int U_PMF_POINT_print(const char **contents, char *out){
   U_FLOAT X, Y;
...
/**
    ...
    EMF+ manual 2.2.2.35, Microsoft name: EmfPlusPoint Object
*/
int U_PMF_POINT_S_print(U_PMF_POINT *Point, char *out){\
   if(!Point){ return(0); }
...
*/
int U_PMF_POINTF_print(const char **contents, char *out){
   U_FLOAT X, Y;
...
/**
    ...
    EMF+ manual 2.2.2.36, Microsoft name: EmfPlusPointF Object
*/
int U_PMF_POINTF_S_print(U_PMF_POINTF *Point, char *out){
   if(!Point){ return(0); }
...
*/
int U_PMF_POINTR_print(const char **contents, U_FLOAT *Xpos, U_FLOAT *Ypos, char *out){
   U_FLOAT X, Y;
...
*/
int U_PMF_RECT_print(const char **contents, char *out){
...
*/
int U_PMF_RECT_S_print(U_PMF_RECT *Rect, char *out){
...
/**
    ...
    EMF+ manual 2.2.2.39, Microsoft name: EmfPlusRectF Object
*/
int U_PMF_RECTF_print(const char **contents, char *out){
...
/**
    ...
    EMF+ manual 2.2.2.39, Microsoft name: EmfPlusRectF Object
*/
int U_PMF_RECTF_S_print(U_PMF_RECTF *Rect, char *out){
...
*/
int U_PMF_REGIONNODE_print(const char *contents, int Level, char *out){
...
*/
int U_PMF_REGIONNODECHILDNODES_print(const char *contents, int Level, char *out){
   uint32_t    size,rsize;
...
*/
int U_PMF_REGIONNODEPATH_print(const char *contents, char *out){
   int32_t Size;
   const char *Data;
...
*/
int U_PMF_SOLIDBRUSHDATA_print(const char *contents, char *out){
   U_PMF_ARGB Color;
...
*/
int U_PMF_STRINGFORMATDATA_print(const char *contents, uint32_t TabStopCount, uint32_t RangeCount, char *out){
...
*/
int U_PMF_TEXTUREBRUSHDATA_print(const char *contents, char *out){
   uint32_t Flags;
   int32_t  WrapMode;
   const char *Data;
...
*/
int U_PMF_TEXTUREBRUSHOPTIONALDATA_print(const char *contents, int HasImage, char *out){
   U_PMF_TRANSFORMMATRIX   Matrix;
   const char *Image;
...
*/
int U_PMF_TRANSFORMMATRIX_print(const char *contents, char *out){
   U_PMF_TRANSFORMMATRIX Tm;
...
/**
    ...
    EMF+ manual 2.2.2.47, Microsoft name: EmfPlusTransformMatrix Object
*/
int U_PMF_TRANSFORMMATRIX2_print(U_PMF_TRANSFORMMATRIX *Tm, char *out){
...
*/
int U_PMF_ROTMATRIX2_print(U_PMF_ROTMATRIX *Rm, char *out){
...
*/
int U_PMF_IE_BLUR_print(const char *contents, char *out){
   U_FLOAT  Radius;
   uint32_t ExpandEdge;
...
*/
int U_PMF_IE_BRIGHTNESSCONTRAST_print(const char *contents, char *out){
...
*/
int U_PMF_IE_COLORBALANCE_print(const char *contents, char *out){
...
*/
int U_PMF_IE_COLORCURVE_print(const char *contents, char *out){
...
*/
int U_PMF_IE_COLORLOOKUPTABLE_print(const char *contents, char *out){
...
*/
int U_PMF_IE_COLORMATRIX_print(const char *contents, char *out){
...
*/
int U_PMF_IE_HUESATURATIONLIGHTNESS_print(const char *contents, char *out){
...
*/
int U_PMF_IE_LEVELS_print(const char *contents, char *out){
...
*/
int U_PMF_IE_REDEYECORRECTION_print(const char *contents, char *out){
   int32_t Elements;
   U_RECTL *Rects;
...
*/
int U_PMF_IE_SHARPEN_print(const char *contents, char *out){
   U_FLOAT  Radius;
   int32_t  Sharpen;
...
*/
int U_PMF_IE_TINT_print(const char *contents, char *out){
   int32_t  Hue, Amount;
...
*/
int U_PMR_OFFSETCLIP_print(const char *contents, char *out){
   U_PMF_CMN_HDR Header;
   U_FLOAT       dX,dY;
...
*/
int U_PMR_RESETCLIP_print(const char *contents, char *out){
...
*/
int U_PMR_SETCLIPPATH_print(const char *contents, char *out){
   int CMenum;
   uint32_t PathID;
...
*/
int U_PMR_SETCLIPRECT_print(const char *contents, char *out){
   int CMenum;
   U_PMF_RECTF Rect;
...
*/
int U_PMR_SETCLIPREGION_print(const char *contents, char *out){
   int CMenum;
   uint32_t PathID;
...
*/
int U_PMR_COMMENT_print(const char *contents, char *out){
   U_PMF_CMN_HDR Header;
   const char *Data;
   unsigned int i=0;
...
*/
int U_PMR_ENDOFFILE_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}
...
*/
int U_PMR_GETDC_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}
...
*/
int U_PMR_HEADER_print(const char *contents, char *out){
...
*/
int U_PMR_CLEAR_print(const char *contents, char *out){
   U_PMF_ARGB Color;
...
*/
int U_PMR_DRAWARC_print(const char *contents, char *out){
   uint32_t PenID;
   int ctype;
   U_FLOAT Start, Sweep;
   U_PMF_RECTF Rect;
...
*/
int U_PMR_DRAWBEZIERS_print(const char *contents, char *out){
   uint32_t PenID;
   int ctype, RelAbs;
   uint32_t Elements;
   U_PMF_POINTF *Points;
...
*/
int U_PMR_DRAWCLOSEDCURVE_print(const char *contents, char *out){
   uint32_t PenID; 
   int ctype, RelAbs;
   U_FLOAT Tension;
   uint32_t Elements;
...
*/
int U_PMR_DRAWCURVE_print(const char *contents, char *out){
   uint32_t PenID;
   int ctype;
   U_FLOAT Tension;
...
*/
int U_PMR_DRAWDRIVERSTRING_print(const char *contents, char *out){
   unsigned int           i;
   uint32_t               FontID;
   int                    btype;
   U_FLOAT                Tension;
...
*/
int U_PMR_DRAWELLIPSE_print(const char *contents, char *out){
   uint32_t PenID;
   int ctype;
   U_PMF_RECTF Rect;
...
*/
int U_PMR_DRAWIMAGE_print(const char *contents, char *out){
...
*/
int U_PMR_DRAWIMAGEPOINTS_print(const char *contents, char *out){
   uint32_t      ImgID, ImgAttrID;
...
*/
int U_PMR_DRAWLINES_print(const char *contents, char *out){
   uint32_t PenIdx;
...
*/
int U_PMR_DRAWPATH_print(const char *contents, char *out){
...
*/
int U_PMR_DRAWPIE_print(const char *contents, char *out){
   uint32_t PenID;
   int ctype;
   U_FLOAT Start, Sweep;
   U_PMF_RECTF Rect;
...
*/
int U_PMR_DRAWRECTS_print(const char *contents, const char *blimit, char *out){
   uint32_t PenID;
   int      ctype;
   uint32_t Elements;
...
*/
int U_PMR_DRAWSTRING_print(const char *contents, char *out){
   char *String8=NULL;
...
*/
int U_PMR_FILLCLOSEDCURVE_print(const char *contents, char *out){
   uint32_t BrushID;
...
*/
int U_PMR_FILLELLIPSE_print(const char *contents, char *out){
   int btype, ctype;
   uint32_t BrushID;
   U_PMF_RECTF Rect;
...
*/
int U_PMR_FILLPATH_print(const char *contents, char *out){
   int btype;
...
*/
int U_PMR_FILLPIE_print(const char *contents, char *out){
   int btype, ctype;
   U_FLOAT Start, Sweep;
   uint32_t BrushID;
   U_PMF_RECTF Rect;
...
*/
int U_PMR_FILLPOLYGON_print(const char *contents, char *out){
...
*/
int U_PMR_FILLRECTS_print(const char *contents, const char *blimit, char *out){
   int btype, ctype;
   uint32_t BrushID, Elements;
   U_PMF_RECTF *Rects;
   U_PMF_CMN_HDR hdr;
...
*/
int U_PMR_FILLREGION_print(const char *contents, char *out){
...
*/
int U_PMR_OBJECT_print(const char *contents, const char *blimit, U_OBJ_ACCUM *ObjCont, int term, char *out){
   U_PMF_CMN_HDR Header;
   uint32_t ObjID;
   int otype, ntype;
   uint32_t TSize;
...
//int k; const char *cptr; for(cptr=contents, k=0; k<608;k++,cptr++){ printf("%3.3d %2.2X\n",k,*(uint8_t*)cptr); }; fflush(stdout);
   ...
   */
   ...
   if(status){
      switch(ttype){
         case U_OT_Brush:           (void) U_PMF_BRUSH_print(ObjCont->accum, out);            break;
         case U_OT_Pen:             (void) U_PMF_PEN_print(ObjCont->accum, out);              break;
         case U_OT_Path:            (void) U_PMF_PATH_print(ObjCont->accum, out);             break;
         case U_OT_Region:          (void) U_PMF_REGION_print(ObjCont->accum, out);           break;
         case U_OT_Image:           (void) U_PMF_IMAGE_print(ObjCont->accum, out);            break;
         case U_OT_Font:            (void) U_PMF_FONT_print(ObjCont->accum, out);             break;
         case U_OT_StringFormat:    (void) U_PMF_STRINGFORMAT_print(ObjCont->accum, out);     break;
         case U_OT_ImageAttributes: (void) U_PMF_IMAGEATTRIBUTES_print(ObjCont->accum, out);  break;
...
*/
int U_PMR_SERIALIZABLEOBJECT_print(const char *contents, char *out){
   uint8_t GUID[16];
   uint32_t Size;
   const char *Data;
   char *string=NULL;
   ...
   if(status){
      ...
      if(string){
         ...
         switch(iee){
            ...
            case U_IEE_ColorCurveEffectGuid:             U_PMF_IE_COLORCURVE_print(Data, out);             break;
            case U_IEE_ColorLookupTableEffectGuid:       U_PMF_IE_COLORLOOKUPTABLE_print(Data, out);       break;
            case U_IEE_ColorMatrixEffectGuid:            U_PMF_IE_COLORMATRIX_print(Data, out);            break;
            case U_IEE_HueSaturationLightnessEffectGuid: U_PMF_IE_HUESATURATIONLIGHTNESS_print(Data, out); break;
            case U_IEE_LevelsEffectGuid:                 U_PMF_IE_LEVELS_print(Data, out);                 break;
            case U_IEE_RedEyeCorrectionEffectGuid:       U_PMF_IE_REDEYECORRECTION_print(Data, out);       break;
            case U_IEE_SharpenEffectGuid:                U_PMF_IE_SHARPEN_print(Data, out);                break;
            case U_IEE_TintEffectGuid:                   U_PMF_IE_TINT_print(Data, out);                   break;
         }
      }
      else {
...
*/
int U_PMR_SETANTIALIASMODE_print(const char *contents, char *out){
   int SMenum, aatype;
...
*/
int U_PMR_SETCOMPOSITINGMODE_print(const char *contents, char *out){
   int CMenum;
...
*/
int U_PMR_SETCOMPOSITINGQUALITY_print(const char *contents, char *out){
   int CQenum;
...
*/
int U_PMR_SETINTERPOLATIONMODE_print(const char *contents, char *out){
   int IMenum;
...
*/
int U_PMR_SETPIXELOFFSETMODE_print(const char *contents, char *out){
   int POMenum;
...
*/
int U_PMR_SETRENDERINGORIGIN_print(const char *contents, char *out){
   int32_t X, Y;
...
*/
int U_PMR_SETTEXTCONTRAST_print(const char *contents, char *out){
   int GC;
...
*/
int U_PMR_SETTEXTRENDERINGHINT_print(const char *contents, char *out){
   int TRHenum;
...
*/
int U_PMR_BEGINCONTAINER_print(const char *contents, char *out){
   int UTenum;
...
*/
int U_PMR_BEGINCONTAINERNOPARAMS_print(const char *contents, char *out){
   uint32_t StackID;
...
*/
int U_PMR_ENDCONTAINER_print(const char *contents, char *out){
   uint32_t StackID;
...
*/
int U_PMR_RESTORE_print(const char *contents, char *out){
   uint32_t StackID;
...
*/
int U_PMR_SAVE_print(const char *contents, char *out){
   uint32_t StackID;
...
*/
int U_PMR_SETTSCLIP_print(const char *contents, char *out){
   int ctype;
   uint32_t Elements;
   U_PMF_RECTF *Rects;
...
*/
int U_PMR_SETTSGRAPHICS_print(const char *contents, char *out){
   int      vgatype, pptype;
...
*/
int U_PMR_MULTIPLYWORLDTRANSFORM_print(const char *contents, char *out){
   int xmtype;
   U_PMF_TRANSFORMMATRIX Matrix;
...
*/
int U_PMR_RESETWORLDTRANSFORM_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}
...
*/
int U_PMR_ROTATEWORLDTRANSFORM_print(const char *contents, char *out){
   int xmtype;
   U_FLOAT Angle;
...
*/
int U_PMR_SCALEWORLDTRANSFORM_print(const char *contents, char *out){
   int xmtype;
   U_FLOAT Sx, Sy;
...
*/
int U_PMR_SETPAGETRANSFORM_print(const char *contents, char *out){
   int UTenum;
   U_FLOAT Scale;
...
*/
int U_PMR_SETWORLDTRANSFORM_print(const char *contents, char *out){
   U_PMF_TRANSFORMMATRIX Matrix;
...
*/
int U_PMR_TRANSLATEWORLDTRANSFORM_print(const char *contents, char *out){
   int xmtype;
   U_FLOAT Dx, Dy;
...
/**
    ...
    \param  contents    Record from which to print data
*/
int U_PMR_STROKEFILLPATH_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}
...
*/
int U_PMR_MULTIFORMATSTART_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}
...
*/
int U_PMR_MULTIFORMATSECTION_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}
...
*/
int U_PMR_MULTIFORMATEND_print(const char *contents, char *out){
   return(U_PMR_NODATAREC_print(contents, out));
}

int pmf2svg(char *contents, size_t length, char * out)
{
    size_t   off=0;
    size_t   result;
    int      OK =1;
